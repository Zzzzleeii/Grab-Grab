...
if("TRUE" STREQUAL "TRUE")
  set(checkerboard_detector_SOURCE_PREFIX /home/aubo-fy/aubo_ws/src/aubo_i5_realsense_calibration/checkerboard_detector)
  set(checkerboard_detector_DEVEL_PREFIX /home/aubo-fy/aubo_ws/devel/.private/checkerboard_detector)
  ...
  set(checkerboard_detector_INSTALL_PREFIX /home/aubo-fy/aubo_ws/install)
...
if(NOT "/home/aubo-fy/aubo_ws/devel/.private/checkerboard_detector/include " STREQUAL " ")
  set(checkerboard_detector_INCLUDE_DIRS "")
  set(_include_dirs "/home/aubo-fy/aubo_ws/devel/.private/checkerboard_detector/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'checkerboard_detector' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/aubo-fy/aubo_ws/src/aubo_i5_realsense_calibration/checkerboard_detector/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT checkerboard_detector_NUM_DUMMY_TARGETS)
      set(checkerboard_detector_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::checkerboard_detector::wrapped-linker-option${checkerboard_detector_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR checkerboard_detector_NUM_DUMMY_TARGETS "${checkerboard_detector_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::checkerboard_detector::wrapped-linker-option${checkerboard_detector_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND checkerboard_detector_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/aubo-fy/aubo_ws/devel/.private/checkerboard_detector/lib;/home/aubo-fy/aubo_ws/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(checkerboard_detector_EXPORTED_TARGETS ${${checkerboard_detector_dep}_EXPORTED_TARGETS})
endforeach()
